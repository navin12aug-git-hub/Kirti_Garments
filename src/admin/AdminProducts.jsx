...
export default function AdminProducts() {
  ...
  const handleSave = (data) => {
    if (editing) {
      ...
      setProducts((prev) => [{ ...data, id: newId, reviews: [], createdAt: new Date().toISOString().slice(0, 10) }, ...prev]);
  ...
  return (
    <div className="space-y-5">
      ...
      {showModal && <ProductModal product={editing} onClose={() => setShowModal(false)} onSave={handleSave} />}
      {confirmDelete && (
