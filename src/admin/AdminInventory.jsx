...
export default function AdminInventory() {
  ...
  const [items, setItems] = useState(products.map((p) => ({ id: p.id, name: p.name, category: p.category, image: p.images[0], stock: p.stock, price: p.price, availability: p.availability })));
