...
import { products, categories, customerReviews, images } from '../data/mockData';
  ...
  return (
    <div>
        ...
        <div className="relative h-full container-custom flex items-center">
          <div className={`max-w-xl text-white transition-all duration-1000 ${heroLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            <p className="mt-6 text-base md:text-lg text-neutral-200 max-w-md">
              Discover premium fashion for every occasion. From ethnic elegance to contemporary chic.
            </p>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        <img src={images.editorial[0]} alt="New Season Collection" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative container-custom text-center text-white">
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-bold">New Season Collection</h2>
          <p className="mt-4 text-neutral-200 max-w-lg mx-auto">Discover the latest styles from Kirti Garments. Fresh designs that blend tradition with modern aesthetics.</p>
      ...
      <section className="py-16 md:py-20 bg-neutral-900 text-white">
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold">Style More. Spend Less.</h2>
          </div>
