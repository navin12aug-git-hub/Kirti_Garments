...
export default function TrackOrder() {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    setSearched(true);
    const userOrders = JSON.parse(localStorage.getItem('kg_orders') || '[]');
    const all = [...userOrders, ...mockOrders];
    const found = all.find((o) => o.id.toLowerCase().includes(orderId.toLowerCase().trim()));
