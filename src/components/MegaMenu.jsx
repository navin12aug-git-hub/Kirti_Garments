    ...
    <div className="absolute top-full left-0 w-full bg-white border-t border-neutral-200 shadow-lg animate-slide-down z-50">
      <div className="container-custom py-8">
        ...
        <div className="mt-6 pt-6 border-t border-neutral-100 flex gap-4">
          <Link to="/shop?category=men" onClick={onClose} className="text-xs font-semibold tracking-wider uppercase text-neutral-900 hover:text-accent transition-colors">
            Shop All Men →
          </Link>
          <Link to="/shop?category=women" onClick={onClose} className="text-xs font-semibold tracking-wider uppercase text-neutral-900 hover:text-accent transition-colors">
            Shop All Women →
          </Link>
        </div>
      </div>
